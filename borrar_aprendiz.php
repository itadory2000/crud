                     ...
                     <div class="form-row">
                       <br>
                        <div class="form-group col-md-5">
                           <input class="form-control" style="position: relative;right: -10px;bottom: 10px;" type="number" name="numid" min="9999" max="9999999999999" value="" placeholder="IDENTIFICACION"/>
                        </div>
                        <div class="form-group col-md-3">
                           <input class="btn btn-primary" style="position: relative;right: -10px;bottom: -10px;" type="submit" value="Eliminar">
                        </div>
                        <input style="position: relative;right: 470px;bottom: 100px;"  class="btn btn-primary" type="button" onclick="location.href ='menu.php'" value="Regresar">
                 </div>
                  <br>
                </div>
              </from> 
