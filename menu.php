...
<body>
  <div id="div1" class="container">
        <br>
        <div id="div2">
            <?php if($resultado->num_rows>0) { ?> <img src="imagenes/banner2.png" width="400" alt=""> <?php } ?>
            <div id="div3" >
                  <?php
                     ...
                     ?>
                                    <label class="lgris">BIENVENIDOS: <?php echo $_SESSION['nusuario'] ?></label> <br>
                                    ...
                                    <br><br>
                                    <input style="position: relative;right: 600px;bottom: 580px;"  class="btn btn-primary" type="button" onclick="location.href ='index.php'" value="Regresar">
                                    <br><br>
                        <?php
                            }
                            else
