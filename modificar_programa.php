                  ...
                  <div class="col-md-12">
                    ...
                    <div class="form-row">
                      <div class="form-group col-md-5">
                        <input class="form-control" style="position: relative;right: 5px;bottom: 0px;" type="text" name="programa" nautofocus value="" placeholder="PROGRAMA"/>
                      </div>
                      <div class="form-group col-md-3">
                        <input class="btn btn-primary" style="position: relative;right: 5px;bottom: -20px;" type="submit" value="Consultar">
                      </div>
                      <input style="position: relative;right: 480px;bottom: 90px;"  class="btn btn-primary" type="button" onclick="location.href ='menu.php'" value="Regresar"> 
                    </div>
                    <br>
                  </div>
              </form>
